...
class SubscriptionTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->subscription->setProviderSubscriptionId(self::BROKER_SUBSCRIPTION_ID);
    ...
    public function testGetterAndSetters(): void
    {
        ...
        $this->assertEquals(self::BROKER_SUBSCRIPTION_ID, $this->subscription->getProviderSubscriptionId());
